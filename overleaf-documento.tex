...
\departamento{Bacharelado em Inteligência Artificial}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%        Informacao para TCC de Graduacao         %%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\graduacaoem{Inteligência Artificial}
...
\autor{ }
\titulo{Projeto Pedagógico do Curso}
\data{2025}
\local{Quixadá}
...
\renewcommand{\imprimircapa}{%
	\begin{capa}%
		...
		% \MakeUppercase{Curso de Graduação em \imprimirgraduacaoem} \\
...
\def\nomedocurso{\imprimirgraduacaoem\xspace}
...
\begin{document}	
	...
	%Elementos textuais
	\textual
	\input{2-textuais/01-apresentacao.tex}
        \input{2-textuais/02-historico-da-ufc.tex}
        \input{2-textuais/03-historico-do-curso.tex}
        \input{2-textuais/04-identificacao-do-curso.tex}
        \input{2-textuais/05-principios-norteadores.tex}
        \input{2-textuais/06-objetivos-do-curso.tex}
        \input{2-textuais/07-perfil-profissional.tex}
        \input{2-textuais/08-areas-de-atuacao.tex}
        \input{2-textuais/09-estrutura-curricular.tex}
        \input{2-textuais/10-estagio-curricular-supervisionado.tex}
        \input{2-textuais/11-trabalho-de-conclusao-de-curso.tex}
        \input{2-textuais/12-atividades-complementares.tex}
        \input{2-textuais/13-extensao.tex}
        %\input{2-textuais/14-atividades-praticas-de-ensino.tex}
        \input{2-textuais/15-metodologias-de-ensino.tex}
        \input{2-textuais/16-procedimentos-de-acompanhamento.tex}
        \input{2-textuais/17-processos-de-avaliacao-interna.tex}
        \input{2-textuais/18-gestao-academica-do-curso.tex}
        \input{2-textuais/19-infraestrutura-do-curso.tex}
...
%	\imprimirglossario	
	...
	\imprimiranexos
		...
		\input{3-pos-textuais/anexos/anexo-c}
		\input{3-pos-textuais/anexos/anexo-d}
		\input{3-pos-textuais/anexos/anexo-e}		
	\imprimirindice
